...
namespace BlackMesa.Website.Main.Areas.Learning.Controllers
{
    ...
    public class TestController : BaseController
    {
        ...
        public ActionResult Setup(SetupTestViewModel viewModel)
        {
            ...
            _learningRepo.GetAllCardsInFolder(folder, ref cardsToTest, true);
        ...
        private TestItemViewModel GetTestItemViewModel(string testId, string folderId, int positionOffset = 0)
        {
            ...
            if (positionOffset == 0)
            {
                var dbCardsToTest = test.CardsToTest.Select(cardToTest => _learningRepo.GetCard(cardToTest.Id.ToString()));
        ...
        public ActionResult SaveTestItem(TestItemViewModel resultViewModel)
        {
            ...
            var test = Session["Test"] as Test;
            var testedCard = _learningRepo.GetCard(resultViewModel.CardId);

            _learningRepo.AddTestItem(testedCard.Id.ToString(), resultViewModel.TestId,
